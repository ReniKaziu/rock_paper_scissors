...
function win(user, computer) {
  ...
  setTimeout( () => roundStatus.classList.remove('winningStyles'), 900)
}
...
function loses(user, computer) {
  ...
  setTimeout( () => roundStatus.classList.remove('losingStyles'), 900)
}
...
function draw(user, computer) {
  ...
  setTimeout( () => roundStatus.classList.remove('drawStyles'), 900)
}
